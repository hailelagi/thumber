defmodule ThumberWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(ThumberWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(ThumberWeb.Gettext, "errors", msg, opts)
    # end
